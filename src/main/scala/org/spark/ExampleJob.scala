...
object ExampleJob {
  def main(args: Array[String]) {
    val transactionsIn = "/Users/smahamka/Documents/hdfs_dir_l/tran_in"
    val usersIn = "/Users/smahamka/Documents/hdfs_dir_l/user_in"
    val conf = new SparkConf().setAppName("SparkJoins").setMaster("local")
    val context = new SparkContext(conf)
    val job = new ExampleJob(context)
    val results = job.run(transactionsIn, usersIn)
    val output = "/Users/smahamka/Documents/hdfs_dir_l/ExampleJobOut"
